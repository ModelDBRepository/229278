function [data_structure] =  ch_hgf_analysis2(data_structure)
...
data_structure.behavioral.hgf.est = tapas_fitModel(y2, [inputs,y1],  'tapas_hgf_binary_config', 'tapas_condhalluc_obs_config');
...
for ii = 1:3
    data_structure.behavioral.summary.hgf2.traj(ii,:) = mean(reshape(data_structure.behavioral.hgf.est.traj.muhat(:,ii),30,12),1);
end
